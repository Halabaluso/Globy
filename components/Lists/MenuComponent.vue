<template>
    <button class="btn btn-primary w-max my-5" onclick="modal_Menu.showModal()"><Icon name = "ph:plus-circle-bold"></Icon> New Menu</button>
                ...
                <tbody>
                    ...
                    <tr v-for="Menu,i in Menu.allMenus" :key="Menu">
                        ...
                        <td class="flex flex-row">
                            <button @click="takeMenuData(i,Menu)" onclick="modal_Menu_delete.showModal()" class="btn btn-error m-1">Delete</button>
                            <button @click="takeMenuData(i,Menu)" onclick="modal_Menu_modify.showModal()" class="btn btn-primary m-1">Modify</button>
                        </td>
                    </tr>
                </tbody>
